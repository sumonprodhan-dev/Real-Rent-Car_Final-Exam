        ...
        <div class="bg-sec-100 ">
            ...
            <div class="flex justify-center md:py-28 py-12 mx-auto max-w-screen-xl">
                <div class="flex  flex-col justify-center md:w-3/5  mx-12 md:ms-20 md:mx-0">
                    <h1 class=" md:text-start text-center  font-car font-bold text-gray-900 mb-8  md:text-7xl text-4xl "><span class="text-blue-600"> EASY
                        </span>AND FAST WAY TO RENT YOUR CAR</h1>
                    ...
                    <div class="flex justify-center md:justify-start mt-12 md:w-2/3 me-12 md:-ms-12">
                        <a href="/cars">
                            <button
                                class="bg-blue-600 p-2 border-2 border-white rounded-md text-white hover:bg-transparent hover:border-blue-400 hover:text-blue-500 w-32 md:me-12 md:mx-12 mx-7 font-bold ">CARS</button>
                        </a>
                        <a href="/contact_us">
                            <button class="border-2 border-blue-400 text-black w-32 p-2 rounded-md hover:border-transparent hover:bg-blue-600 hover:text-white font-bold">CONTACT
                                US</button>
                        </a>
                    </div>
                </div>
                <div class="md:w-3/5 hidden md:block  ">
                    <img loading="lazy" src="/images/home-hero-car.png" alt="home car" class="ml-5 w-full h-auto"></img>
                </div>
            ...
            <div class="mx-auto max-w-screen-xl">
                ...
                <div class="   md:mr-16 mr-4 mb-4 flex justify-end">
                    <a href="/cars">
                        <button
                            class="border-2 border-blue-400 text-black w-16 p-1 rounded-md hover:border-transparent hover:bg-blue-600 hover:text-white">See
                            All</button>
                    </a>
                </div>
            </div>
                ...
                @foreach ($cars as $car)
                    <div
                        ...
                        <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="{{ route('car.reservation', ['car' => $car->id]) }}">
                            ...
                            <span
                                class="absolute top-0 left-0 m-2 rounded-full bg-blue-600 px-2 text-center text-sm font-medium text-white">{{ $car->reduce }}% OFF</span>
                        </a>
                        <div class="mt-4 px-5 pb-5">
                            ...
                            <div class="mt-2 mb-5 flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    ...
                                    @endfor
                                    <span
                                        class="mr-2 ml-3 rounded bg-blue-500 px-2.5 py-0.5 text-xs text-white font-semibold">{{ $car->stars }}.0</span>
                                </div>
                            </div>
                            <a href="{{ route('car.reservation', ['car' => $car->id]) }}"
                                class="flex items-center justify-center rounded-md bg-slate-900 hover:bg-blue-600 px-5 py-2.5 text-center text-sm font-medium text-white  focus:outline-none focus:ring-4 focus:ring-blue-300">
            ...
            <div class="mx-auto max-w-screen-xl mt-16 mb-32">
                <div>
                    <h2 class="text-center font-car text-3xl font-medium text-blue-600"> <span
                ...
                <div
                    ...
                    <div
                        class="flex justify-around md:w-1/3 text-center my-4 h-16 align-middle md:border-b-0 md:border-r-2 border-b-2 pb-4 border-white">
                        <div class="flex flex-col justify-center">
                            <h3 class="font-car font-medium text-4xl">5000 + </h3>
                    ...
                    <div
                        ...
                        <div class="flex flex-col justify-center">
                            <h3 class="font-car font-medium text-4xl">10000 +</h3>
                ...
                <div
                    ...
                    <div class="flex justify-center align-middle ">
                        <div class="bg-gray-800 p-3 rounded-lg mx-3 mb-6 mt-2">
                            <svg class="icon-color" xmlns="http://www.w3.org/2000/svg" height="2.5em" viewBox="0 0 512 512">
