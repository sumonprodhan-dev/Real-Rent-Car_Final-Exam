    ...
    <div class="bg-gray-200 mx-auto max-w-screen-xl mt-10 p-3 rounded-md shadow-xl">
        <form action="{{route('carSearch')}}">
            <div class="flex justify-center md:flex-row flex-col md:gap-28 gap-4">
                ...
                <button class="bg-blue-600 rounded-md text-white p-2 w-20 font-medium hover:bg-pr-500" type="submit" placeholder="brand"> Search</button>
            </div>
        </form>
    </div>
            ...
            <div class="mt-4 px-5 pb-5">
                ...
                <div class="mt-2 mb-5 flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        ...
                        @endfor
                        <span class="mr-2 ml-3 rounded bg-blue-500 px-2.5 py-0.5 text-xs text-white font-semibold">{{ $car->stars }}.0</span>
                    </div>
                </div>
                <a href="{{ route('car.reservation', ['car' => $car->id]) }}" class="flex items-center justify-center rounded-md bg-slate-900 hover:bg-blue-600 px-5 py-2.5 text-center text-sm font-medium text-white  focus:outline-none focus:ring-4 focus:ring-blue-300">
