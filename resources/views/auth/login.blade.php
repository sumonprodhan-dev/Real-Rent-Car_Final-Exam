            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-6">
                    ...
                    <input type="email" id="email" name="email" value={{ old('email') ? old('email') : 'sumonpro.dev@gmail.com' }}
                        ...
                        placeholder="sumonpro.dev@gmail.com">
                    @error('email')
                        <span>
                ...
                <button type="submit"
                    class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-pr-600 dark:hover:bg-pr-700 dark:focus:ring-pr-800">Login</button>
